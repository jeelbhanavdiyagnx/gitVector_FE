  ...
  return (
    <div className="container mx-auto px-4" style={{ marginBottom: '40px' }}>
      ...
      <div className="mt-8 pb-4">
        ...
        <p className="mt-2 text-gray-500">Git Vector</p>
      </div>
      <Separator />
      ...
      <div className="mt-4 space-y-4 text-lg">
        ...
        <ul className="ml-6 list-disc text-base">
          <li>
          ...
          <li>
            ...
            this Agreement) refers to GNX Infinity Pvt Ltd, A-144, PARAMOUNT
            GOLF FOREST VILLAS, PLOT NO. BGH, SITE - C , SURAJPUR GR NOIDA,
          ...
          <li>
            <strong>Website</strong> refers to  Git Vector, accessible from{' '}
        ...
        <ul className="ml-6 list-disc text-base">
          ...
          <li>
            <strong>To contact You:</strong>To contact You: To contact You by
        ...
        <h3 className="text-xl font-bold">Business Transactions</h3>
        <p>
        ...
        <h3 className="text-xl font-bold">Law enforcement</h3>
        <p>
          Under certain circumstances, the Company may be required to disclose
          Your Personal Data if required to do so by law or in response to valid
          requests by public authorities (e.g. a court or a government agency).
        </p>
        <h3 className="text-xl font-bold">Other legal requirements</h3>
        <p>
